...
bool sbsms_convert(const char *filenameIn, const char *filenameOut, bool bAnalyzeOnly, bool bSynthesizeOnly, bool bPreAnalyze, progress_cb progressCB, void *data, float stretch0 = 1.0f, float stretch1 = 1.0f, float pitch0 = 1.0f, float pitch1 = 1.0f, float volume = 1.0f);
